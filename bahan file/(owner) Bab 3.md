...
Dokumen utama yang menjadi objek analisis adalah berkas *Daily Drilling Reports* (DDR) berformat PDF. Dokumen ini merekam parameter teknis operasi sumur pengeboran selama siklus 24 jam. Sebanyak 13 sampel dokumen PDF DDR operasional asli dari PT. Parama Data Unit dikumpulkan, dinormalisasi, serta dijalankan proses anonimisasi pada isi dokumen (*content anonymization*). Anonimisasi ini dilakukan untuk menyamarkan informasi sensitif internal (seperti nama personal personel/kontraktor dan nomor kontak internal) guna menjaga kerahasiaan data perusahaan, tanpa mengubah struktur tata letak tabel, batas sel, maupun atribut data teknis operasional (seperti kedalaman, parameter pengeboran, dan durasi aktivitas) yang menjadi objek utama ekstraksi.
...
Pada tahap pengumpulan data, dilakukan dua aktivitas utama. Pertama, studi literatur secara komprehensif terhadap publikasi ilmiah, laporan teknis, dan dokumentasi resmi mengenai efektivitas model OCR (*PaddleOCR* dan *EasyOCR*) serta algoritma pengenalan tata letak tabel pada dokumen berstruktur rumit. Kedua, pengumpulan 13 sampel dokumen PDF *Daily Drilling Reports* dari PT. Parama Data Unit yang dilanjutkan dengan pembersihan dan anonimisasi atribut sensitif isi dokumen. Terhadap 13 sampel dokumen tersebut, dilakukan transkripsi manual untuk menghasilkan berkas referensi kebenaran absolut (*Ground Truth Text*). Berkas *Ground Truth* ini kelak menjadi standar penilai matematis untuk mengukur tingkat akurasi pembacaan karakter dan kata dari masing-masing model OCR yang diuji.
